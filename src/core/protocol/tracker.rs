use crate::core::protocol::bencode;
use crate::core::torrent::ClientConfig;
...
pub enum TrackerError {
    ...
    BencodeError(#[from] crate::core::protocol::bencode::BencodeError),
...
impl TrackerClient {
    ...
    pub async fn announce(&self, tracker_url: &str, request: &AnnounceRequest) -> Result<AnnounceResponse> {
        ...
        log_debug!("Full announce URL: {}", url);
