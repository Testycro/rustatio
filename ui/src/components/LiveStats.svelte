...
<Card class="p-5 border-2 border-primary shadow-lg shadow-primary/20">
  <h2 class="mb-4 text-primary text-xl font-semibold">⚡ Live Stats</h2>
  <div class="grid grid-cols-2 gap-3">
    <div class="bg-muted p-3 rounded-lg text-center border border-border">
      <span
        ...
        >↑ Upload</span
      >
      <span class="block text-xl font-bold text-green-600 dark:text-green-500"
    ...
    <div class="bg-muted p-3 rounded-lg text-center border border-border">
      <span
        ...
        >Ratio</span
      >
      <span class="block text-xl font-bold text-amber-500">{stats.ratio.toFixed(2)}</span>
    </div>
    <div class="bg-muted p-3 rounded-lg text-center border border-border">
      <span
        class="block text-[0.7rem] text-muted-foreground mb-1 uppercase tracking-wider font-semibold"
